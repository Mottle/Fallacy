...
class AbsorptionHud : HudLayerImpl("absorption") {
    ...
    override fun getPrimaryBarColor(
        ...
        return when (effect) {
            dev.deepslate.fallacy.client.hud.HealthEffect.NONE -> COLORS[index]
            dev.deepslate.fallacy.client.hud.HealthEffect.POISON -> POISON_COLORS[index]
            dev.deepslate.fallacy.client.hud.HealthEffect.WITHER -> WITHER_COLORS[index]
        }
    }
